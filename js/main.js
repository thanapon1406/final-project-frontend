    ...
    const carouselHTML = `
        <div class="container-fluid px-0">
            <div id="mainCarousel" class="carousel slide" data-bs-ride="carousel" 
                 data-bs-interval="${data.controls.interval || 5000}">
                ...
                <div class="carousel-inner">
                    ${data.slides.map((slide, index) => `
                        <div class="carousel-item ${index === 0 ? 'active' : ''}" data-slide-id="${slide.id}">
                            <img src="${slide.image || 'https://via.placeholder.com/1200x500'}" 
                                 class="d-block w-100" alt="${slide.title}" loading="${index === 0 ? 'eager' : 'lazy'}">
                ...
                ${data.controls.prevButton ? `
                    <button class="carousel-control-prev" type="button" data-bs-target="#mainCarousel" data-bs-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="visually-hidden">Previous</span>
                    </button>
                ` : ''}
                ${data.controls.nextButton ? `
